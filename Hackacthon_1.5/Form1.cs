...
namespace Hackacthon_1._5
{
    public partial class Form1 : Form
    {
        ...
        {
            string word = dateTimePicker1.Value.ToShortDateString();
            ...
            for(int i=0;i<date.Length;i++)
            {
                ...
                {
                    x = x + int.Parse(s[j].ToString());
                }
            }
            CheckNumber(x);
            CheckDate(GetAtomFromBirthday(dateTimePicker1.Value));
            prin();
        ...
        {
            string s = "關於您 : \n\n您的星座是 : ";
            s = s += GetAtomFromBirthday(dateTimePicker1.Value) + "\n\n";
            s = s += "您的生命係數是 : " + number + digit[number];
            label2.Text = s;
        }
        ...
        public void CheckDate(string date)
        {
            switch(date)
            {
                ...
                case "天蠍座":
                    ...
                    break;
                case "射手座":
                    digit = CreateSagittarius();
                    break;
                case "摩羯座":
                    digit = CreateCapricorn();
                    break;
                case "水瓶座":
                    digit = CreateAquarius();
                    break;
                case "雙魚座":
                    digit = CreatePieces();
                    break;
        ...
        public void CheckNumber(int date)
        {
